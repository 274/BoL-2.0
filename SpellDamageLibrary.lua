    ...
    function getDmg(spellname,target,owner,stagedmg,spelllvl)
            ...
            local Qlvl = spelllvl and spelllvl or owner:GetSpellData(0).level
            local Wlvl = spelllvl and spelllvl or owner:GetSpellData(1).level
            local Elvl = spelllvl and spelllvl or owner:GetSpellData(2).level
            local Rlvl = spelllvl and spelllvl or owner:GetSpellData(3).level
            ...
            elseif spellname == "Q" or spellname == "W" or spellname == "E" or spellname == "R" or spellname == "P" or spellname == "QM" or spellname == "WM" or spellname == "EM" then
                    ...
                    elseif name == "Amumu" then
                            ...
                            elseif spellname == "W" then DmgM = ((.3*Wlvl+1.2+.01*ap)*tmhp/100)+4*Wlvl+4 --xsec
                    ...
                    elseif name == "Azir" then
                            if spellname == "Q" then DmgM = 30*Qlvl+30+.5*ap --beyond the first will deal only 25% damage
                            elseif spellname == "W" then DmgM = math.max(5*lvl+45,10*lvl-10)+.7*ap--after the first deals 25% damage
                    ...
                    elseif name == "Cassiopeia" then
                            ...
                            elseif spellname == "E" then DmgM = 25*Elvl+30+(.05*Elvl+.35)*ap
                    ...
                    elseif name == "Fiora" then
                            ...
                            elseif spellname == "R" then DmgP = math.max(170*Rlvl-10+1.2*bad,(170*Rlvl-10+1.2*bad)*2*stagedmg3) --xstrike , without counting on-hit effects, Successive hits against the same target deal 25% damage. stage3: Max damage
                            end
                    ...
                    elseif name == "Gnar" then
                            if spellname == "Q" then DmgP = 35*Qlvl-25+ad -- 50% damage beyond the first
                            elseif spellname == "QM" then DmgP = 40*Qlvl-30+1.2*ad
                            elseif spellname == "W" then DmgM = 5*Wlvl+20+ap+(2*Wlvl+4)*tmhp/100
                    ...
                    elseif name == "Katarina" then
                            ...
                            elseif spellname == "R" then DmgM = math.max(17.5*Rlvl+22.5+.25*ap+.375*bad,(17.5*Rlvl+22.5+.25*ap+.375*bad)*10*stagedmg3) --xdagger (champion can be hit by a maximum of 10 daggers (2 sec)). stage3: Max damage
                            end
                    ...
                    elseif name == "Lucian" then
                            if spellname == "P" then DmgP = (.5+.25*math.floor(lvl/13))*ad TypeDmg = 2 -- 50-75% of Lucian's AD based on level 13
                            elseif spellname == "Q" then DmgP = 30*Qlvl+50+(15*Qlvl+45)*bad/100
                            elseif spellname == "W" then DmgM = 40*Wlvl+20+.9*ap+.3*bad
                    ...
                    elseif name == "Ryze" then
                            if spellname == "Q" then DmgM = 25*Qlvl+35+.4*ap+.065*mmana
                    ...
                    elseif name == "Sejuani" then
                            if spellname == "Q" then DmgM = 30*Qlvl+10+.4*ap+(2*Qlvl+2)*tmhp/100
                            elseif spellname == "W" then DmgM = math.max((20*Wlvl+20+.3*ap)*stagedmg1,(10*Wlvl+10+.15*ap+2.5*(mhp-440-lvl*95)/100)*stagedmg2,(10*Wlvl+10+.15*ap+2.5*(mhp-440-lvl*95)/100)*4*stagedmg3) TypeDmg = 1+stagedmg1 --stage1: bonus. stage2: xsec (4 sec). stage3: stage2*4 sec
                            elseif spellname == "E" then DmgM = 50*Elvl+10+.5*ap
                            elseif spellname == "R" then DmgM = 100*Rlvl+50+.8*ap
                            end
                    ...
                    elseif name == "Sona" then
                            ...
                            elseif spellname == "Q" then DmgM = math.max((40*Qlvl+.5*ap)*(stagedmg1+stagedmg3),(10*Qlvl+30+.25*ap+10*Rlvl)*stagedmg2) TypeDmg = 1+stagedmg2 --stage1-3: Active. stage2:On-hit
                            elseif spellname == "R" then DmgM = 100*Rlvl+50+.5*ap
                            end
                    ...
                    elseif name == "Warwick" then
                            ...
                            elseif spellname == "R" then DmgM = math.max(17*Rlvl+33+.4*bad,(17*Rlvl+33+.4*bad)*5*stagedmg3) --xstrike (5 strikes) , without counting on-hit effects. stage3: Max damage
                            end
                    ...
                    elseif name == "Zac" then
                            ...
                            elseif spellname == "E" then DmgM = 40*Elvl+40+.7*ap
            ...
            elseif (spellname == "ISPARK" or spellname == "MADREDS" or spellname == "ECALLING" or spellname == "EXECUTIONERS" or spellname == "MALADY") then
                    ...
                    Global.print("Error spellDmg "..name.." "..spellname)
                    TrueDmg = 0
            end
